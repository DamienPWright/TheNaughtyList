function EnEyeBird(X, Y){
    Enemy.call(this, X, Y, "en_eyebird");
    this.maxHP = 2;
    this.curHP = 2;
    this.contact_damage = 1;
    
    this.body.collideWorldBounds = true;
    this.body.setSize(42, 36, 42, 20);
    this.dir = DIR_NORTH;
...
EnEyeBird.prototype = Object.create(Enemy.prototype);
EnEyeBird.prototype.constructor = EnEyeBird;