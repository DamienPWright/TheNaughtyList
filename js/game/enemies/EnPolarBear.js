function EnPolarBear(X, Y){
    Enemy.call(this, X, Y, "en_polarbear");
    this.maxHP = 15;
    this.curHP = 15;
    this.contact_damage = 2;
    
    this.body.collideWorldBounds = true;
    this.body.setSize(62, 30, 2, 34);
    this.dir = DIR_NORTH;
...
EnPolarBear.prototype = Object.create(Enemy.prototype);
EnPolarBear.prototype.constructor = EnPolarBear;